...
struct
  ...
  val test4 = [(1,2),(1,12),(2,11),(2,3),(3,4),(11,4),(2,4),(4,5),(3,12),(4,6),(4,12),(11,7),(5,7),(6,7),(1,8),(4,9),(9,7),(8,4)]
  val testfile = "input/thesaurus.txt"
  val testfile2 = "input/simpletest.txt"

  (* The following are required *)
  val testsNum = [edgeseq, edgeseq2, test3, test4];

  val testsOutNeighbors = [(edgeseq, 1), (edgeseq, 2),(test3,1),(edgeseq2,5),(edgeseq2,7),(test3,9),(test4,11)]

  val testsReport = [((edgeseq, 1), 2), ((edgeseq2, 1), 4), ((edgeseq2, 1), 7),((test3,4),2),((test3,1),3),((test3,6),2),((test3,1),6),((test4,11),3)]
